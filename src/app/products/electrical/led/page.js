...
const products = [
    ...
    { name: 'LED Bulbs', description: 'High-lumen LED bulbs for residential and commercial lighting with long lifespan and energy savings.', image: '/images/products/electrical/led/led-bulb-b22.jpg', specs: ['Wattage: 5W–50W', 'Base: B22/E27', 'Lumens: Up to 4500'] },
    ...
    { name: 'LED Highbay Lights', description: 'Industrial LED highbay lights for warehouses, factories, and large indoor spaces with high ceilings.', image: '/images/products/electrical/led/led-highbay-light-warehouse.jpg', specs: ['Wattage: 50W–500W', 'Height: 6m–15m', 'Beam: 60°/90°/120°'] },
    ...
    { name: 'LED Batten Lights', description: 'Surface-mounted LED batten lights for corridors, garages, basements, and utility areas.', image: '/images/products/electrical/led/led-batten-light-surface.jpg', specs: ['Length: 2ft/4ft', 'Wattage: 10W–40W', 'Type: Surface Mount'] },
    ...
    { name: 'Flame Proof LED Lights', description: 'Flameproof LED fittings for mining, refineries, and locations with flammable gases or vapors.', image: '/images/products/electrical/led/flame-proof-led-light-fitting.jpg', specs: ['Type: FLP', 'Gas Group: IIA/IIB/IIC', 'Material: Aluminum Alloy'] },
    { name: 'LED Wall Lights', description: 'Decorative and functional LED wall lights for corridors, staircases, and outdoor facades.', image: '/images/products/electrical/led/led-wall-light-outdoor.jpg', specs: ['Wattage: 3W–20W', 'Direction: Up/Down/Both', 'IP Rating: IP44/IP65'] },
];
