...
const products = [
    ...
    { name: 'Solid Bottom Cable Trays', description: 'Enclosed solid bottom trays for sensitive cable protection in industrial and hazardous environments.', image: '/images/products/electrical/cable-tray/solid-bottom-cable-tray-enclosed.jpg', specs: ['Material: GI/SS/Aluminum', 'Width: 50–600mm', 'Cover: Optional'] },
    ...
    { name: 'Cable Tray Accessories', description: 'Complete range of cable tray fittings including bends, tees, reducers, couplers, and supports.', image: '/images/products/electrical/cable-tray/cable-tray-fittings-bend-tee-reducer.jpg', specs: ['Types: Bend/Tee/Cross', 'Material: GI/SS', 'Standard: IS 16295'] },
];
