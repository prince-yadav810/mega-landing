...
const products = [
    ...
    { name: 'RDs (Residual Current Devices)', description: 'RCCB and RCBO devices for earth leakage protection and personal safety against electric shock.', image: '/images/products/electrical/switchgears/rds-residual-current-devices.jpg', specs: ['Sensitivity: 30/100/300mA', 'Poles: 2P/4P', 'Type: AC/A'] },
    { name: 'Contactors', description: 'Power contactors for switching motors, lighting loads, and capacitor banks in industrial applications.', image: '/images/products/electrical/switchgears/contactors.jpg', specs: ['Rating: 9A–630A', 'Coil: AC/DC', 'Category: AC-1/AC-3'] },
    ...
    { name: 'Capacitors', description: 'Power factor correction capacitors for improving power quality and reducing electricity bills.', image: '/images/products/electrical/switchgears/capacitors.jpg', specs: ['Rating: 1–50 kVAR', 'Voltage: 440V/690V', 'Type: MPP/APP'] },
    { name: 'Relays', description: 'Control relays, overload relays, and protection relays for motor control and automation circuits.', image: '/images/products/electrical/switchgears/relays.jpg', specs: ['Type: Thermal/Electronic', 'Range: 0.1A–630A', 'Contact: NO/NC'] },
    { name: 'Starters', description: 'DOL, Star-Delta, and soft starters for controlled motor starting and reduced inrush current.', image: '/images/products/electrical/switchgears/starters.jpg', specs: ['Type: DOL/Star-Delta/Soft', 'Rating: Up to 500HP', 'Voltage: 415V'] },
    { name: 'Fuses', description: 'HRC fuses, kit kat fuses, and fuse links for overcurrent protection in electrical circuits.', image: '/images/products/electrical/switchgears/fuses.jpg', specs: ['Type: HRC/Kit Kat', 'Rating: 2A–800A', 'Breaking: Up to 80kA'] },
    { name: 'Switch Disconnectors', description: 'Load break switch disconnectors for safe isolation of electrical circuits during maintenance.', image: '/images/products/electrical/switchgears/switch-disconnectors.jpg', specs: ['Rating: 16A–3150A', 'Poles: 3P/4P', 'Operation: Manual/Motor'] },
    ...
    { name: 'Screw Terminals', description: 'DIN rail screw terminal blocks for secure wire connections in control panels and distribution boards.', image: '/images/products/electrical/switchgears/screw-terminals.jpg', specs: ['Size: 2.5–150 sq mm', 'Material: PA66', 'Mounting: DIN Rail'] },
    { name: 'Limit Switches', description: 'Industrial limit switches for position sensing and machine control in automation applications.', image: '/images/products/electrical/switchgears/limit-switches.jpg', specs: ['Type: Roller/Plunger', 'Contact: SPDT/DPDT', 'IP Rating: IP67'] },
    { name: 'Meters', description: 'Digital and analog meters for voltage, current, power, and energy measurement in panels.', image: '/images/products/electrical/switchgears/meters.jpg', specs: ['Type: Ammeter/Voltmeter/MFM', 'Display: Digital/Analog', 'Accuracy: Class 0.5'] },
    { name: 'Surge Protection Devices', description: 'SPD devices for protecting sensitive equipment from voltage surges and lightning strikes.', image: '/images/products/electrical/switchgears/surge-protection-devices.jpg', specs: ['Type: Type 1/2/3', 'Discharge: Up to 100kA', 'Protection: 275V/385V'] },
    { name: 'Birelay', description: 'Bimetallic overload relay for thermal protection of motors against overheating and overcurrent.', image: '/images/products/electrical/switchgears/birelay.jpg', specs: ['Range: 0.1A–100A', 'Type: Bimetallic', 'Reset: Manual/Auto'] },
    { name: 'Plugs and Sockets', description: 'Industrial plugs, sockets, and interlocking connectors for safe power connections in factories.', image: '/images/products/electrical/switchgears/plugs-and-sockets.jpg', specs: ['Rating: 16A–125A', 'IP Rating: IP44/IP67', 'Poles: 3P+E/3P+N+E'] },
    { name: 'Wiring Accessories', description: 'Modular switches, plates, sockets, and accessories for residential and commercial wiring.', image: '/images/products/electrical/switchgears/wiring-accessories.jpg', specs: ['Type: Modular', 'Rating: 6A/16A/20A', 'Material: PC/Polycarbonate'] },
