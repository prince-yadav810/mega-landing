...
const products = [
    { name: 'Copper Tubular Lugs', description: 'Tinned and untinned copper tubular lugs for secure cable termination in panels and switchgear.', image: '/images/products/electrical/lugs-glands/copper-tubular-lugs.jpg', specs: ['Material: Copper', 'Size: 1.5–630 sq mm', 'Type: Tubular'] },
    { name: 'Aluminum Lugs', description: 'Aluminum cable lugs for terminating aluminum conductors in power distribution systems.', image: '/images/products/electrical/lugs-glands/aluminum-lugs.jpg', specs: ['Material: Aluminum', 'Size: 16–630 sq mm', 'Type: Ring/Fork'] },
    { name: 'Bimetallic Lugs', description: 'Copper-aluminum bimetallic lugs for connecting aluminum cables to copper bus bars without corrosion.', image: '/images/products/electrical/lugs-glands/bimetallic-lugs.jpg', specs: ['Material: Cu-Al Bimetal', 'Size: 16–630 sq mm', 'Anti-Corrosion'] },
    { name: 'Ring Lugs', description: 'Ring-type cable lugs for bolt-through connections in panels, motors, and terminal blocks.', image: '/images/products/electrical/lugs-glands/ring-lugs.jpg', specs: ['Type: Ring', 'Hole: M5–M16', 'Insulated Options'] },
    { name: 'Pin & Fork Lugs', description: 'Pin-type and fork-type lugs for quick-connect terminal block and relay connections.', image: '/images/products/electrical/lugs-glands/pin-fork-lugs.jpg', specs: ['Type: Pin/Fork', 'Size: 0.5–6 sq mm', 'Insulated: Yes'] },
    { name: 'Bootlace Ferrules', description: 'Insulated bootlace ferrules for crimping fine-stranded wires before inserting into terminals.', image: '/images/products/electrical/lugs-glands/bootlace-ferrules.jpg', specs: ['Size: 0.25–50 sq mm', 'Insulated: Color Coded', 'Twin: Available'] },
