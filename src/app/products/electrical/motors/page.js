...
const products = [
    { name: 'Electrical Motors', description: 'General-purpose electric motors for a wide range of industrial, commercial, and agricultural applications.', image: '/images/products/electrical/motors/electrical-motors.jpg', specs: ['Power: 0.18kW–375kW', 'Frame: 63–355', 'Efficiency: IE2/IE3'] },
    { name: 'AC Motors', description: 'Three-phase and single-phase AC motors for pumps, compressors, fans, and conveyors.', image: '/images/products/electrical/motors/ac-motors.jpg', specs: ['Phase: 1Ø/3Ø', 'Speed: 750–3000 RPM', 'Voltage: 230V/415V'] },
    { name: 'Induction Motors', description: 'Squirrel cage induction motors with robust construction for continuous duty industrial applications.', image: '/images/products/electrical/motors/induction-motors.jpg', specs: ['Type: Squirrel Cage', 'Duty: S1 Continuous', 'Enclosure: TEFC'] },
    ...
    { name: 'Sewage & Dewatering Pumps', description: 'Heavy-duty sewage submersible and dewatering pumps for construction sites and wastewater handling.', image: '/images/products/electrical/motors/sewage-dewatering-pumps.jpg', specs: ['Power: 1–50 HP', 'Solids: Up to 80mm', 'Type: Non-Clog/Cutter'] },
    { name: 'Dosing Pumps', description: 'Chemical dosing pumps for precise metering of chemicals in water treatment and industrial processes.', image: '/images/products/electrical/motors/dosing-pumps.jpg', specs: ['Flow: 0.5–500 LPH', 'Type: Diaphragm/Piston', 'Control: Manual/Auto'] },
];
