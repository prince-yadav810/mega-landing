...
const products = [
    ...
    { name: 'Seamless Pipe', description: 'Seamless mild steel pipes for high-pressure applications, boilers, and hydraulic systems.', image: '/images/products/structural-steel/ms-pipes/ms-square-pipe-hollow-section.jpg', specs: ['OD: 21–610mm', 'Standard: IS 1239/ASTM', 'Pressure: High'] },
    { name: 'Square Tube', description: 'Mild steel square tubes for furniture, frames, structures, and decorative applications.', image: '/images/products/structural-steel/ms-pipes/ms-square-pipe-hollow-section.jpg', specs: ['Size: 12x12–200x200mm', 'Thickness: 1–6mm', 'Finish: ERW'] },
    { name: 'Rectangular Tube', description: 'Rectangular hollow section tubes for structural framing, gates, and fabrication work.', image: '/images/products/structural-steel/ms-pipes/ms-rectangular-tube-hollow-section.jpg', specs: ['Size: 20x10–300x200mm', 'Thickness: 1–6mm', 'Standard: IS 4923'] },
