...
const products = [
    { name: 'Office Cabin', description: 'Pre-fabricated portable office cabins for construction sites, temporary offices, and remote locations.', image: '/images/products/structural-steel/porta-cabins/office-cabin.jpg', specs: ['Size: 10x10–40x12 ft', 'Structure: MS Frame', 'Insulation: PUF/EPS'] },
    ...
    { name: 'Toilet Cabin', description: 'Portable toilet cabins with plumbing provisions for construction sites and outdoor events.', image: '/images/products/structural-steel/porta-cabins/toilet-cabin.jpg', specs: ['Type: Western/Indian', 'Plumbing: Complete', 'Water Tank: Optional'] },
    ...
    { name: 'Storage Container', description: 'Secure storage containers for tools, equipment, and material storage on construction sites.', image: '/images/products/structural-steel/porta-cabins/storage-container.jpg', specs: ['Size: 10–40 ft', 'Lock: Heavy Duty', 'Weatherproof: Yes'] },
];
