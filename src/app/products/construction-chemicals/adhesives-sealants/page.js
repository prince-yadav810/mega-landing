...
const products = [
    ...
    { name: 'PU Sealant', description: 'Polyurethane sealants for construction joints, expansion joints, and concrete crack sealing.', image: '/images/products/construction-chemicals/adhesives-sealants/acrylic-sealant-paintable.jpg', specs: ['Type: 1-Part/2-Part', 'Elongation: >600%', 'Paintable: Yes'] },
