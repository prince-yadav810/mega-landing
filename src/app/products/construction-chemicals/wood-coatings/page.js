...
const products = [
    ...
    { name: 'PU Wood Finish', description: 'Polyurethane wood finishes for premium-quality, scratch-resistant furniture and interior woodwork.', image: '/images/products/construction-chemicals/wood-coatings/pu-wood-finish.jpg', specs: ['Type: 1K/2K PU', 'Finish: Gloss/Satin/Matt', 'Scratch Resistant'] },
