...
const products = [
    ...
    { name: 'Stainer', description: 'Universal stainers and tinting colors for custom shade mixing with emulsion and enamel paints.', image: 'https://images.unsplash.com/photo-1581092334241-cb19ecef850f?w=600&h=600&fit=crop', specs: ['Type: Universal', 'Pack: 50ml–1L', 'Compatible: Emulsion/Enamel'] },
