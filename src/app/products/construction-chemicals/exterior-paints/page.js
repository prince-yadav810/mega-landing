...
const products = [
    ...
    { name: 'Weather Coat', description: 'All-weather exterior paint with hydrophobic technology for water and stain repellence.', image: '/images/products/construction-chemicals/exterior-paints/exterior-emulsion-paint-weatherproof.jpg', specs: ['Technology: Water Repellent', 'Life: 7–10 Years', 'Crack Bridging: Yes'] },
    { name: 'Damp Proof Paint', description: 'Anti-dampness paint for walls affected by moisture seepage and rising dampness.', image: '/images/products/construction-chemicals/exterior-paints/exterior-emulsion-paint-weatherproof.jpg', specs: ['Anti-Damp: Yes', 'Coats: 2–3', 'Coverage: 60–80 sqft/L'] },
