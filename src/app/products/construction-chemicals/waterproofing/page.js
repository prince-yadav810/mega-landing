...
const products = [
    ...
    { name: 'Terrace Waterproofing', description: 'Elastomeric coatings and systems for terrace and flat roof waterproofing with crack-bridging capability.', image: '/images/products/construction-chemicals/waterproofing/waterproofing-membrane-liquid-applied.jpg', specs: ['Elongation: >300%', 'Reflective: Optional', 'Coverage: 1.5–2 kg/sqm'] },
    { name: 'Bathroom Waterproofing', description: 'Flexible liquid waterproofing for bathrooms, showers, and wet rooms before tiling.', image: '/images/products/construction-chemicals/waterproofing/waterproofing-membrane-liquid-applied.jpg', specs: ['Type: Acrylic/Cementitious', 'Drying: 4–6 Hours', 'Coats: 2–3'] },
    { name: 'Foundation Waterproofing', description: 'Below-grade waterproofing systems for foundations, retaining walls, and underground structures.', image: '/images/products/construction-chemicals/waterproofing/waterproofing-membrane-liquid-applied.jpg', specs: ['Type: Membrane/Coating', 'Hydrostatic: Yes', 'Standard: BS 8102'] },
];
