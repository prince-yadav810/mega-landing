...
const products = [
    ...
    { name: 'Ring Making Machine', description: 'Automatic ring making machines for producing circular stirrups and rings from TMT bars.', image: '/images/products/construction-equipment/bar-bending-cutting/ring-making-machine-stirrup1.jpg', specs: ['Bar Size: 6–12mm', 'Diameter: 100–600mm', 'Speed: High'] },
