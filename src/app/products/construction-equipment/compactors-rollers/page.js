...
const products = [
    ...
    { name: 'Single Drum Roller', description: 'Single drum vibratory rollers for soil, gravel, and sub-base compaction in road construction.', image: '/images/products/construction-equipment/compactors-rollers/smooth-drum-roller-compactor1.jpg', specs: ['Weight: 3–14 Ton', 'Drum: Single', 'Vibration: Variable'] },
    { name: 'Pneumatic Roller', description: 'Pneumatic tire rollers for finishing compaction of asphalt and soil surfaces.', image: '/images/products/construction-equipment/compactors-rollers/smooth-drum-roller-compactor2.jpg', specs: ['Weight: 8–27 Ton', 'Tires: 7–11', 'Type: Static/Vibratory'] },
    { name: 'Vibratory Roller', description: 'Walk-behind vibratory rollers for compacting small areas, footpaths, and driveways.', image: '/images/products/construction-equipment/compactors-rollers/smooth-drum-roller-compactor3.jpg', specs: ['Weight: 500–1000 kg', 'Width: 600–700mm', 'Operation: Walk-Behind'] },
];
