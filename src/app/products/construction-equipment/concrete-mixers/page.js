...
const products = [
    ...
    { name: 'Tilting Drum Mixer', description: 'Manual tilting drum mixers for small batches of concrete, mortar, and plaster.', image: '/images/products/construction-equipment/concrete-mixers/reversible-drum-mixer-concrete.jpg', specs: ['Capacity: 140–500L', 'Tilt: Manual', 'Power: Electric'] },
