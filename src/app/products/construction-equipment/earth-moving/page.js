...
const products = [
    ...
    { name: 'Wheel Loader', description: 'Front-end wheel loaders for loading trucks, stockpile management, and material handling.', image: '/images/products/construction-equipment/earth-moving/wheel-loader-front-end1.jpg', specs: ['Bucket: 1–5 cu m', 'Power: 80–300 HP', 'Lift: 3–4m'] },
