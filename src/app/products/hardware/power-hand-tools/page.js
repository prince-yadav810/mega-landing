...
const products = [
    ...
    { name: 'Screwdrivers', description: 'Professional screwdriver sets in flat, Phillips, Torx, and insulated variants for electrical work.', image: '/images/products/hardware/power-hand-tools/screwdrivers.jpg', specs: ['Set: 6–12 Pcs', 'Type: Flat/Phillips/Torx', 'Insulated: VDE 1000V'] },
    ...
    { name: 'Chisels', description: 'Cold chisels, wood chisels, and masonry chisels for cutting, carving, and demolition work.', image: '/images/products/hardware/power-hand-tools/chisels.jpg', specs: ['Material: Chrome Steel', 'Width: 12–25mm', 'Type: Cold/Wood/Masonry'] },
    { name: 'Measuring Tools', description: 'Tape measures, spirit levels, calipers, and laser distance meters for precise measurement.', image: '/images/products/hardware/power-hand-tools/measuring-tools.jpg', specs: ['Type: Tape/Level/Laser', 'Range: Various', 'Accuracy: ±1mm'] },
];
