...
const products = [
    { name: 'Jute Hessian Cloth', description: 'Natural jute hessian cloth for concrete curing, packaging, and erosion control applications.', image: '/images/products/hardware/hessian-cloths/jute-hessian-cloth.jpg', specs: ['Material: 100% Jute', 'Width: 40"–72"', 'Weight: 7.5–14 oz'] },
    { name: 'Burlap Rolls', description: 'Burlap rolls for agricultural use, decorative applications, and landscape fabric.', image: '/images/products/hardware/hessian-cloths/burlap-rolls.jpg', specs: ['Width: 36"–72"', 'Length: 50–100 yards', 'Weave: Standard'] },
    { name: 'Curing Hessian', description: 'Hessian cloth specifically treated for concrete curing to maintain moisture and ensure proper setting.', image: '/images/products/hardware/hessian-cloths/curing-hessian.jpg', specs: ['Use: Concrete Curing', 'Reusable: Yes', 'Size: Custom'] },
