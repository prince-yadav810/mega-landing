...
const products = [
    ...
    { name: 'Sanding Belts', description: 'Abrasive sanding belts for belt sanders, edge sanders, and industrial sanding machines.', image: '/images/products/hardware/abrasives/flap-disc-sanding.jpg', specs: ['Size: Various', 'Grit: 40–400', 'Material: AO/Zirconia'] },
