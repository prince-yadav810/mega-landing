...
const products = [
    ...
    { name: 'Fire Hose', description: 'Canvas and rubber-lined fire hoses with couplings for fire-fighting systems.', image: '/images/products/safety/fire-safety/fire-hose-reel-cabinet.jpg', specs: ['Diameter: 63–75mm', 'Length: 15–30m', 'Pressure: 10–15 bar'] },
    { name: 'Smoke Detector', description: 'Optical and ionization smoke detectors for early fire warning in commercial and residential properties.', image: '/images/products/safety/fire-safety/fire-alarm-system-smoke-detector.jpg', specs: ['Type: Optical/Ionization', 'Coverage: 60 sqm', 'Power: Battery/Mains'] },
