...
const products = [
    ...
    { name: 'PVC Gloves', description: 'PVC dipped gloves for wet work, chemical handling, and rough surface gripping.', image: '/images/products/safety/safety-gloves/pvc-chemical-resistant-gloves1.jpg', specs: ['Coating: PVC', 'Length: 10"–14"', 'Grip: Rough Finish'] },
