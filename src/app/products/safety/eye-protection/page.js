...
const products = [
    { name: 'Safety Goggles', description: 'Splash-proof and chemical-resistant safety goggles for laboratory and industrial environments.', image: '/images/products/safety/eye-protection/safety-goggles-chemical-splash1.jpg', specs: ['Lens: Polycarbonate', 'Ventilation: Indirect', 'Standard: EN 166'] },
