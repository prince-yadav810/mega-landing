...
const products = [
    ...
    { name: 'Convex Mirror', description: 'Traffic convex mirrors for blind spots, road junctions, and parking garage visibility.', image: 'https://images.unsplash.com/photo-1581092334241-cb19ecef850f?w=600&h=600&fit=crop', specs: ['Diameter: 24"–40"', 'Material: Acrylic/PC', 'View: 130°'] },
    ...
    { name: 'Delineator Post', description: 'Flexible delineator posts with reflective panels for lane marking and road edge guidance.', image: 'https://images.unsplash.com/photo-1581092334241-cb19ecef850f?w=600&h=600&fit=crop', specs: ['Height: 750–1200mm', 'Material: PVC/PE', 'Flexible: Yes'] },
];

export default function RoadSafetyPage() {
    return (
        <ProductListing title="Road Safety" description="Traffic management and road safety products for construction zones, highways, parking areas, and urban roads." benefits={['High Visibility', 'Durable Materials', 'Reflective Options', 'Bulk Supply']} products={products} categoryBackLink="/products" />
    );
}
