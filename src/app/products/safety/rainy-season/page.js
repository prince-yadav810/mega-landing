...
const products = [
    ...
    { name: 'Rain Suit', description: 'Two-piece rain suits with jacket and trousers for complete rain protection during outdoor work.', image: '/images/products/safety/rainy-season/raincoat-pvc-heavy-duty1.jpg', specs: ['Pieces: 2 (Jacket+Trouser)', 'Material: Nylon/PVC', 'Reflective: Optional'] },
    ...
    { name: 'Umbrella', description: 'Heavy-duty golf and construction umbrellas for site supervisors and security personnel.', image: '/images/products/safety/rainy-season/Umbrella.png', specs: ['Size: 23"–30"', 'Frame: Fiberglass', 'Wind Resistant: Yes'] },
];

export default function RainySeasonPage() {
    return (
        <ProductListing title="Rainy Season Items" description="Monsoon essentials for construction sites and outdoor workers — rainwear, gumboots, waterproof covers, and rain protection gear." benefits={['100% Waterproof', 'Durable Materials', 'All Sizes', 'Quick Delivery']} products={products} categoryBackLink="/products" fitImages={true} />
    );
}
