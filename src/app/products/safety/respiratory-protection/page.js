...
const products = [
    { name: 'Dust Mask', description: 'Disposable dust masks for protection against non-toxic dust, pollen, and airborne particles.', image: '/images/products/safety/respiratory-protection/dust-mask-n95-respirator1.jpg', specs: ['Class: FFP1/FFP2', 'Valve: Optional', 'Disposable: Yes'] },
    ...
    { name: 'Cartridge Filter', description: 'Replacement cartridge filters for reusable respirators — organic vapor, acid gas, and particulate.', image: '/images/products/safety/respiratory-protection/half-face-respirator-cartridge1.jpg', specs: ['Type: OV/AG/P100', 'Life: 40 Hours', 'Compatible: Standard'] },
...
export default function RespiratoryProtectionPage() {
    return (
        <ProductListing title="Respiratory Protection" description="Respiratory protection equipment from disposable masks to powered air systems for dust, chemical, and toxic environments." benefits={['CE Certified', 'All Protection Levels', 'Comfortable Seal', 'Replacement Filters']} products={products} categoryBackLink="/products" fitImages={true} />
    );
}
